...
![Front](v1/images/6d-front-2.gif)
...
<details>
    <summary>Version 1, prototype</summary>
The original board was extended with a piece of a prototyping board on which additional segments, transistors and buttons are mounted.

  <IMG src="v1/images/6-digit-board-1.jpg" alt="Board 2"/>
  <IMG src="v1/images/6-digit-board-2.jpg" alt="Board 2"/>
  <IMG src="v1/images/6-digit-board-3.jpg" alt="Board 3"/>
  <IMG src="v1/images/6-digit-board-4.jpg" alt="Board 4"/>
  <IMG src="v1/images/6-digit-board-5.jpg" alt="Board 5"/>
  <IMG src="v1/images/6-digit-front.jpg" alt="Front"/>
  <IMG src="v1/images/6-digit-board-demo.jpg" alt="Front"/>
</details>
...
### New screens
- Main
![Main](v1/images/6d-front.JPG)

- Temperature
![Temperature](v1/images/6d-temperature.JPG)

- Date
![Date](v1/images/6d-date.JPG)

- Alarm
![Alarm](v1/images/6d-alarm.JPG)

- NMEA settings
  - Timezone (1 h)
  ![NMEA timezone is set to -12 hours](v1/images/6d-nmea_tz_1h.JPG)
  - Timezone (-12 h)
  ![NMEA timezone is set to -12 hours](v1/images/6d-nmea_tz_m12h.JPG)
  - DST (daylight saving time) is ON
  ![NMEA DST is on](v1/images/6d-nmea_dst_on.JPG)
  - DST (daylight saving time) is OFF
  ![NMEA DST is off](v1/images/6d-nmea_dst_off.JPG)
  - Automatic time synchronization is set to 3 hours
  ![NMEA autoupdate is set to 3h](v1/images/6d-nmea_upd_3h.JPG)
  - Automatic time synchronization is OFF
  ![NMEA autoupdate is off](v1/images/6d-nmea_upd_off.JPG)

## Operation flow
The operation flow is shown on the following diagram:

[![Operation flow](v1/images/6-digit-clock-operation-flow.png)](v1/images/6-digit-clock-operation-flow.png)
...
The case is made from 3mm thick clear acrylic using laser cutting. It consist of 7 parts, designed in Inkscape, the SVG files can be found [here](v1/case/6-digit-case.svg). The parts are glued together to form the front and back sides, which are connected with 2mm screws and spacers.

![Front](v1/images/6d-persep.JPG)

![Back](v1/images/6d-back.JPG)
</details>
